...
function submitPost(){
  ...
  if(document.getElementById('upload-image-url').value) {
    ...
    var body = "[![]("+imagelink[0]+")](https://terrive.one/?u="+username+"&p="+title.replaceAll(" ","-")+") <br><br>"+descBody+" <br><br> Posted using [Terrive](https://terrive.one)";
    ...
    var bodyVC = "[![]("+coverV+")](https://terrive.one/?u="+username+"&p="+title.replaceAll(" ","-")+"&video) <br><br>"+descBody+" <br><br> Posted using [Terrive](https://terrive.one)";
    ...
    var bodyV = "[![]("+alt+")](https://terrive.one/?u="+username+"&p="+title.replaceAll(" ","-")+"&video) <br><br>"+descBody+" <br><br> Posted using [Terrive](https://terrive.one)";
...
function broadcastPost(u,body,jsonMetadata,type,title){
  if (accessToken) {
    client.comment('',type,u,title.replaceAll(" ","-"),title,body,jsonMetadata, function (err,res) {
