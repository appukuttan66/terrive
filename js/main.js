  ...
  hive.api.getContentReplies(u,p,function(e,r){
    if(e === null){
      ...
      while (counter < r.length){
        document.querySelector("#post-tray .modal-body .post-comment").innerHTML += '<br><div class="mx-3 shadow alert-light rounded p-3 mx-auto position-relative" style="max-width: 36em;"><img src="'imgHoster+'/u/'+r[counter].author+'/avatar/small" height="24" width="24"><a class="fw-bold link-dark text-decoration-none" href="?u='+r[counter].author+'">'+r[counter].author+'</a><br><span class="reply-body">'+md.render(r[counter].body)+ '</span><a href="?u='+r[counter].author+'&p='+r[counter].permlink+'&reply" class="link-dark satisfy">reply</a><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="var(--bs-secondary)" class="bi bi-star-fill position-absolute p-2 top-0 end-0" viewBox="0 0 16 16"><path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/></svg></div><br><div class="child-replies-'+counter+'" data-tr-permlink="'+r[counter].permlink+'" data-tr-author="'+r[counter].author+'"></div>';
        counter = counter + 1;
      }
    }else{notify(e,"var(--bs-danger)");}
  })
