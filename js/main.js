...
function pushProfileInfo (res) {
  ...
  if (res[0].name == username) {
    document.getElementById("profile-info").innerHTML += '<button class="btn btn-outline-primary" data-bs-target="#profile-edit" data-bs-toggle="modal">Edit Profile</button>'
  }
}
